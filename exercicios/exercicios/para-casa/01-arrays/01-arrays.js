...
console.log("O segundo item é", arrayExercicio[1]);


// Imprima o último item da array
// Imprima o item que não é uma fruta
console.log( arrayExercicio[6],"é o último e não é fruta");

// Imprima o item do meio da array
console.log("aO item do meio é", arrayExercicio[3]);


// Imprima "Eu gosto mais de banana do que figo" usando a array no lugar das frutas
console.log( "Eu gosto mais de ",arrayExercicio[0],"do que de ",arrayExercicio[6]);
