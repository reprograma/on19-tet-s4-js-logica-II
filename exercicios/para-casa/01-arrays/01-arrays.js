...
console.log('Segundo item do array:', arrayExercicio[1]);
...
console.log('Item do meio dp array:', arrayExercicio[3]);
...
console.log('Esse item não é uma fruta:', arrayExercicio[6]);
