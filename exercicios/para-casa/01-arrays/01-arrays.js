...
const arrayExercicio = ["Banana", "Pêra", "Uva", "Maçã", "Figo", "Abacaxi", "Caviar"];

// Imprima o segundo item da array
console.log("Segundo item da array: ", arrayExercicio[1]);

// Imprima o último item da array
console.log("Último item da array: ", arrayExercicio[6])

// Imprima o item do meio da array
console.log("Item do meio da array: ", arrayExercicio[3]);
...
console.log(`O item desta lista que não se trata de uma fruta é o ${arrayExercicio[6]}`);