...
console.log(arrayExercicio.includes("banana"));

// usando includes, verifique se a array contém a palavra 'figo'
console.log(arrayExercicio.includes("figo"));

// usando includes, verifique se a array contém a palavra 'macarrão'
console.log(arrayExercicio.includes("macarrão"));
