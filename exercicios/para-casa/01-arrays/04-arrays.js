...
console.log(frase.indexOf("cachorro")); // Devolve -1 porque o valor não existe no array
...
console.log(arrayExercicio.indexOf("macarrão")); // Devolve -1 porque o valor não existe no array
